export default function Hero() {
    return (
        <div className={"grid lg:grid-cols-1 lg:grid-rows-1 grid-cols-1 grid-rows-1"}>
            <div
                ...
                <div className={"w-full text-white flex lg:justify-center lg:items-center flex-col p-14 gap-3"}>
                    <div
                        className={"text-white drop-shadow-lg font-extrabold text-5xl lg:text-8xl flex flex-col justify-start items-start"}>
                        <span>Hi, I am</span>
